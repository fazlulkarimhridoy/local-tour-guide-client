...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-50 text-gray-800 mt-20">
            ...
            <div className="py-6 text-sm text-center text-gray-600">© 2023 Tour Company. All rights reserved by Fazlul Karim(CEO)</div>
        </footer>
    );
};
