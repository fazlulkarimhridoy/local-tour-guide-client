...
const ServiceDetail = () => {
    ...
    // services details
    const { data: serviceDetails = [], isLoading: isServiceDetailsLoading, isPending: isServiceDetailsPending, isFetching: isServiceDetailsFetching } = useQuery({
    ...
    // other services
    const { data: otherServices = [], isLoading: isOtherServicesLoading, isPending: isOtherServicesPending, isFetching: isOtherServicesFetching } = useQuery({
